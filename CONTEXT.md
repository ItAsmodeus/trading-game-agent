...
| Фаза | Что | Статус |
|------|-----|--------|
| 1 | PPO агент, Sharpe > 1.2 | ✅ Sharpe=1.21 |
| 1.5 | Rolling Training + Funding Rate + Risk Engine | 🔄 Реализовано, нужен запуск |
| 2 | LSTM архитектура | ⏳ |
| 2 | Self-Play: Агент Альфа vs Агент Бета | ⏳ |
| 3 | Testnet 30 дней | ⏳ |
| 3 | Funding Arb стратегия (первый реальный доход) | ⏳ |
| 4 | C++ execution engine | ⏳ Q3 2026 |
| 5 | Real money микрокапитал $500-1000 | ⏳ Q4 2026 |
