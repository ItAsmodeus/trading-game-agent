...
## Совет экспертов (Personas)

Реальные люди чьё мнение мы учитываем при принятии решений.
Читать перед каждым крупным решением. Папка: `personas/`

| Персона | Кто | Роль в проекте |
|---------|-----|----------------|
| [Никита Котковский](personas/nikita_kotkovsky.md) | Трейдер, скептик | Проверка реализма. Вопрос: "кто победит?" |
| [Ваня Попов](personas/vanya_popov.md) | Algo trader, владелец ООО, клиент Viking | Технические стратегии, потенциальный клиент |

**Как использовать:** перед решением задай вопрос каждому:
- Никита: "Ты соревнуешься с правильными людьми?"
- Ваня: "Ты знаешь все переменные или угадываешь?"
